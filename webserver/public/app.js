import{n as e}from"./rolldown-runtime.js";import{Bn as t,Ct as n,Rt as r,Wt as i,_n as a,an as o,fn as s,hn as c,in as l,ln as u,mn as d,pn as f,sn as p,un as m}from"./diagram-vendor.js";import{a as h,i as g,n as ee,r as _,t as te}from"./bpmn-vendor.js";import{t as ne}from"./vendor.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var re=`<?xml version="1.0" encoding="UTF-8"?>
...
`,v=`Safeness`,y=`OptionToComplete`,b=`ProperCompletion`,x=`NoDeadActivities`,S=[v,y,b,x];function ie(e){let t=ae();e.on(`analysis.start`,n=>{ce(t,n.xml,e)})}function ae(){let e=window.location.port;return e===`3000`?`:`+(parseInt(e)+1):e===``?``:`:`+e}function oe(e){e.messages=new Map(Object.entries(e.messages)),e.snapshots.forEach(e=>{e.tokens=new Map(Object.entries(e.tokens))})}function se(e){e.property_results.forEach(e=>{e.counter_example&&(oe(e.counter_example.start_state),e.counter_example.transitions.forEach(e=>{oe(e.next_state)}))})}async function ce(e,t,n){let r=performance.now(),i=await C(e,t);if(!i)return;se(i);let a=performance.now()-r;console.log(`BPMN analysis runtime (webservice): `+a+` ms`),n.fire(`analysis.done`,i)}async function C(e,t){try{let n=await fetch(`${window.location.protocol}//${window.location.hostname}${e}/check_bpmn`,{method:`POST`,body:JSON.stringify({bpmn_file_content:t,properties_to_be_checked:[v,y,b,x]}),headers:{"Content-type":`application/json; charset=UTF-8`}});if(!n.ok){console.error(`Analysis request failed:`,n.status,n.statusText);return}return await n.json()}catch(e){console.error(`Error:`,e)}}ie.$inject=[`eventBus`];var le={__init__:[`analysisWebClient`],analysisWebClient:[`type`,ie]},w=`counterexample.visualization.toggleMode`,ue=`counterexample.playExecution`,T=`counterexample.pauseExecution`,de=`counterexample.animationCreated`,fe=`counterexample.animationSpeedChanged`,E=`counterexample.execution.trace`,D=`counterexample.visualization.start`,O=`counterexample.visualization.restart`,pe=`counterexample.visualization.started`,k=`analysis-note`;function me(e,t){e.on(`analysis.done`,n);function n(e){if(t.remove({type:k}),!(!e||!e.property_results))for(let t of e.property_results)t.property===`Safeness`&&!t.fulfilled&&r(t),t.property===`ProperCompletion`&&!t.fulfilled&&i(t),t.property===`NoDeadActivities`&&!t.fulfilled&&a(t),t.property===`OptionToComplete`&&!t.fulfilled&&o(t)}function r(e){s(e,{bottom:-5,left:5},`Two or more tokens`,`small-note`)}function i(e){s(e,{bottom:50,right:-5},`Consumes two or more tokens`,`big-note`)}function a(e){for(let t of e.problematic_elements)c(t,{bottom:-5,left:17.5},`Dead Activity`,`big-note`,!1)}function o(e){for(let n of e.problematic_elements)t.remove({element:n});s(e,{bottom:-5,left:5},`Flow can contain more than 50 tokens.`,`big-note`)}function s(t,n,r,i){for(let a of t.problematic_elements){c(a,n,r,i,!0);let o=document.getElementById(a+`_counter`);o&&o.addEventListener(`click`,()=>{e.fire(D,{propertyResult:t})})}}function c(e,n,r,i,a){t.add(e,k,{position:n,html:`<div id="${e}_counter" class="property-note tooltip ${i}${a?` clickable`:``}">
               ${r}
               ${a?`<span class="tooltipText">Click to visualize an execution example.</span>`:``}
             </div>`})}}me.$inject=[`eventBus`,`overlays`];var A={__init__:[`analysisOverlays`],analysisOverlays:[`type`,me]},j=75;function he(e,t){this.preExecute=function(n){let i=n.unsafeCause,a=e.createShape({type:`bpmn:ExclusiveGateway`},{x:i.x+i.width+j,y:r(i).y},i.parent),o=M(i,[]);t.makeSpace(o,[],{x:j,y:0},`e`,0);let s=i.outgoing.map(e=>e);for(let t of s)e.reconnectStart(t,a,r(a));e.connect(i,a)}}he.$inject=[`modeling`,`spaceTool`];function M(e,t){return e.outgoing.forEach(n=>{let r=n.target;r.x>e.x&&!t.includes(r)&&(t.push(r),r.label&&t.push(r.label),M(r,t))}),t}function ge(e,t,n,i){let a=[],o=n.createShape({type:`bpmn:ExclusiveGateway`});o.x=e.x+e.width+j-o.width/2,o.y=r(e).y-o.height/2,a.push(o);let s=n.createConnection({type:`bpmn:SequenceFlow`});s.waypoints=i.layoutConnection(s,{source:e,target:o}),a.push(s),e.outgoing.forEach(e=>{let t=n.createConnection({type:`bpmn:SequenceFlow`}),s=n.createShape({type:e.target.type});s.x=e.target.x+j,s.y=e.target.y;let c=r(o);t.waypoints=i.layoutConnection(t,{source:o,target:s,connectionStart:c}),a.push(t)});let c={x:j,y:0},l=M(e,[]);l.forEach(e=>e.outgoing.forEach(e=>l.push(e)));let u=l.map(e=>({element:e,delta:c}));t.create({created:a,moved:u,removed:e.outgoing})}var N=-75;function _e(e,t){this.preExecute=function(n){let i=n.unsafeMerge,a=e.createShape({type:`bpmn:ParallelGateway`},{x:i.x+N,y:r(i).y},i.parent),o=P(i,[]);t.makeSpace(o,[],{x:N,y:0},`e`,0);let s=r(a);i.incoming.map(e=>e).forEach(t=>e.reconnectEnd(t,a,s)),e.connect(a,i)}}_e.$inject=[`modeling`,`spaceTool`];function ve(e,t,n,i){let a=[],o=n.createShape({type:`bpmn:ParallelGateway`});o.x=e.x+N-o.width/2,o.y=r(e).y-o.height/2,a.push(o);let s=n.createConnection({type:`bpmn:SequenceFlow`});s.waypoints=i.layoutConnection(s,{source:o,target:e}),a.push(s),e.incoming.forEach(e=>{let t=n.createConnection({type:`bpmn:SequenceFlow`}),s=n.createShape({type:e.source.type});s.x=e.source.x+N,s.y=e.source.y;let c=r(o);t.waypoints=i.layoutConnection(t,{source:s,target:o,connectionEnd:c}),a.push(t)});let c={x:N,y:0},l=P(e,[]);l.forEach(e=>e.incoming.forEach(e=>l.push(e)));let u=l.map(e=>({element:e,delta:c}));t.create({created:a,moved:u,removed:e.incoming})}function P(e,t){return e.incoming.forEach(n=>{let r=n.source;r.x<e.x&&!t.includes(r)&&(t.push(r),r.label&&t.push(r.label),P(r,t))}),t}function ye(e){this.preExecute=function(t){let n=t.problematicEndEvent,i=r(n);n.incoming.slice(1).forEach(t=>{let a=e.createShape({type:`bpmn:EndEvent`},{x:i.x,y:r(t.source).y},n.parent);e.reconnectEnd(t,a,{x:a.x,y:a.y}),e.layoutConnection(t,{waypoints:[]})});let a=n.incoming[0].source,o={x:0,y:r(a).y-Math.round(n.height/2)-n.y};e.moveShape(n,o)}}ye.$inject=[`modeling`];function be(e,t,n,i){let a=[];e.incoming.forEach(t=>{let o=n.createShape({type:`bpmn:EndEvent`});o.x=e.x,o.y=r(t.source).y-Math.round(e.height/2),a.push(o);let s=n.createConnection({type:`bpmn:SequenceFlow`});s.waypoints=i.layoutConnection(s,{source:t.source,target:o}),a.push(s)}),t.create({created:a,removed:e.incoming})}var F=`quick-fix-note`,xe=``;function Se(e,t,n,r,a,o,s,c,l,u){n.on(w,e=>{let t=document.getElementsByClassName(`djs-overlay-container`).item(0);e.active?t.classList.add(`quick-fixes-hide`):t.classList.remove(`quick-fixes-hide`)}),o.registerHandler(`addSubsequentExclusiveGatewayCommand`,he),o.registerHandler(`addPrecedingParallelGatewayCommand`,_e),o.registerHandler(`addEndEventsForEachIncFlowCommand`,ye),n.on(`analysis.done`,e=>{r.remove({type:F}),e.property_results.filter(e=>!e.fulfilled).forEach(t=>{t.property===`Safeness`&&le(t.problematic_elements[0],t),t.property===`ProperCompletion`&&oe(t.problematic_elements[0]),t.property===`OptionToComplete`&&y(t,e.property_results),t.property===`NoDeadActivities`&&re(t)})});function d(e,t){let n;return e.parent.children.filter(n=>n.x<e.x&&g(n,`bpmn:FlowNode`)&&n.type!==`label`&&f(n)&&!h(n,[`bpmn:EndEvent`])&&!t.includes(n.id)).forEach(t=>{if(!n)n=t;else{let r=e.x-n.x;e.x-t.x<r&&(n=t)}}),n}function f(e){return g(e,`bpmn:StartEvent`)||e.incoming.length>0}function p(e,t){let n=d(e,t);n&&A(e,{top:-45,left:T(e)},`Click to add an incoming sequence flow to fix the dead Activity.`,()=>{a.connect(n,e)},()=>{let t=l.createConnection({type:`bpmn:SequenceFlow`});t.waypoints=u.layoutConnection(t,{source:n,target:e}),s.create({created:[t]})})}function m(e,t,n){let r=_(e,t);if(r){let t={getConnection:()=>l.createConnection({type:`bpmn:MessageFlow`})};A(e,{top:-45,left:T(e)},`Click to add incoming message flow to fix ${n}`,()=>{a.connect(r,e)},()=>{t.connectionPreviewGfx=void 0,c.drawPreview(t,!0,{source:r,target:e})},()=>{c.cleanUp(t)})}}function _(e,t){if(!e.parent.parent)return;let n=e.parent.parent.children.filter(t=>g(t,`bpmn:Participant`)&&t!==e.parent).flatMap(e=>e.children).filter(e=>e.type!==`label`&&h(e,[`bpmn:IntermediateThrowEvent`,`bpmn:EndEvent`])&&ee(e,`bpmn:MessageEventDefinition`)||g(e,`bpmn:SendTask`)&&!t.includes(e.id)),r,a;return n.forEach(t=>{if(!r)r=t,a=i(e,r);else{let n=i(e,t);n<a&&(r=t,a=n)}}),r}function te(e){return e.incoming.filter(e=>g(e,`bpmn:SequenceFlow`)).length}function ne(e){return e.incoming.filter(e=>g(e,`bpmn:MessageFlow`)).length}function re(e){e.problematic_elements.forEach(n=>{let r=t.get(n);if(te(r)===0){p(r,e.problematic_elements);return}g(r,`bpmn:ReceiveTask`)&&ne(r)===0&&m(r,e.problematic_elements,`the dead Receive Task.`)})}function v(e){A(e,{top:-45,left:7.5},`Click to change gateway to parallel to guarantee termination.`,()=>{N(e)},()=>{})}function y(e,t){if(!e.counter_example)return;let n=e.counter_example.transitions.slice(-1).pop();n&&n.next_state.snapshots.forEach(e=>{ie(e.tokens),b(e.tokens,t)})}function b(e,n){let r=n.find(e=>e.property===x);e.forEach((e,n)=>{let i=t.get(n);if(!i)return;let a=i.target;g(a,`bpmn:IntermediateCatchEvent`)&&ee(a,`bpmn:MessageEventDefinition`)&&ne(a)===0&&m(a,r.problematic_elements,`the blocking Message Catch Event.`)})}function S(e){let n=[];return e.forEach((e,r)=>{let i=t.get(r);if(!i)return;let a=i.target;g(a,`bpmn:ParallelGateway`)&&a.incoming.length>1&&n.push(a)}),n}function ie(e){let t=S(e);if(t.length===1){let e=t.pop();ae(e);let n=O(e);n&&v(n)}}function ae(e){A(e,{top:-45,left:7.5},`Click to change gateway to exclusive to guarantee termination.`,()=>{M(e)},()=>{})}function oe(e){let n=t.get(e);n.incoming.length<=1||A(n,{top:-45,left:0},`Click to create additional end events.`,()=>{o.execute(`addEndEventsForEachIncFlowCommand`,{problematicEndEvent:n})},()=>{be(n,s,l,u)})}function se(e,t){let n=e.source;if(n.incoming.length>1&&ce(n,t))return n;for(let e of n.incoming){let n=se(e,t);if(n)return n}}function ce(e,t){return!e.incoming.some(e=>t.includes(e.id))}function C(e,t,n,r){let i=e.source;if(i.outgoing.length>1&&r(i)&&t.push(i),i.incoming)for(let e of i.incoming)n.includes(e)||(n.push(e),C(e,t,n,r));return t}function le(e,n){let r=se(t.get(e),n.problematic_elements);if(r){ue(r);let e=pe(r);e&&E(e)}}function ue(e){g(e,`bpmn:ExclusiveGateway`)?me(e):de(e)}function T(e){return e.width/2-17}function de(e){A(e,{top:-45,left:T(e)},`Click to add preceding parallel gateway to fix synchronization.`,()=>o.execute(`addPrecedingParallelGatewayCommand`,{unsafeMerge:e}),()=>{ve(e,s,l,u)})}function fe(e){A(e,{top:-45,left:T(e)},`Click to add subsequent exclusive gateway to fix synchronization.`,()=>o.execute(`addSubsequentExclusiveGatewayCommand`,{unsafeCause:e}),()=>{ge(e,s,l,u)})}function E(e){g(e,`bpmn:ParallelGateway`)?D(e):fe(e)}function D(e){A(e,{top:-45,left:7.5},`Click to change gateway to exclusive to fix synchronization.`,()=>{M(e)},()=>{})}function O(e){return k(e.incoming.map(e=>C(e,[],[],e=>e.type===`bpmn:ExclusiveGateway`)))}function pe(e){return k(e.incoming.map(e=>C(e,[],[],e=>e.type!==`bpmn:ExclusiveGateway`)))}function k(e){for(let t of e[0])if(e.every(e=>e.includes(t)))return t}function me(e){A(e,{top:-45,left:7.5},`Click to change gateway to parallel to fix synchronization.`,()=>{N(e)},()=>{})}function A(e,t,n,i,a,o=()=>s.cleanUp()){if(j(e))return;r.add(e,F,{position:t,html:`<div id=${e.id} class="small-note quick-fix-note tooltip">
               <img alt="quick-fix" src="data:image/svg+xml;base64,${xe}"/>
               <span class="tooltipText">${n}</span>
           </div>`});let c=document.getElementById(e.id);c&&(c.addEventListener(`click`,()=>{o(),i()}),c.addEventListener(`mouseenter`,()=>{a()}),c.addEventListener(`mouseleave`,()=>{o()}))}function j(e){return r.get({element:e,type:F}).length>0}function M(t){e.replaceElement(t,{type:`bpmn:ExclusiveGateway`})}function N(t){e.replaceElement(t,{type:`bpmn:ParallelGateway`})}}Se.$inject=[`bpmnReplace`,`elementRegistry`,`eventBus`,`overlays`,`modeling`,`commandStack`,`complexPreview`,`connectionPreview`,`elementFactory`,`layouter`];var Ce={__init__:[`quickFixes`],quickFixes:[`type`,Se]};function we(e,t,n,r,i,a,o){this._notifications=a,t.on(D,e=>{e.propertyResult&&u(e.propertyResult)});let s={},c;t.on(O,()=>{c&&u(c)}),t.on(`analysis.done`,e=>{e.property_results.forEach(e=>{l(e)})});function l(e){let t=document.getElementById(e.property);if(t&&(t.removeEventListener(`click`,s[e.property]),t.classList.remove(`clickable`),!e.fulfilled&&e.counter_example)){t.classList.add(`clickable`);let n=u.bind(this,e);t.addEventListener(`click`,n),s[e.property]=n}}function u(n){c=n,e.clearAnimations(),r.clearTokenCounts(),i.clearMessageCounts(),t.fire(w,{active:!0}),t.fire(pe,{propertyResult:n}),a.showNotification({text:`Visualizing execution example started.`}),d(n)}function d(e){p(e.property,{snapshots:[],messages:new Map},e.counter_example.start_state,e.counter_example.transitions,-1)}function f(e,r,i,o){if(o>=i.length){a.showNotification({text:`Visualizing execution example finished.`});return}let s=i[o],c=n.get(s.label);if(!c){f(e,r,i,o+1);return}t.fire(E,{element:c,property:e}),p(e,r,s.next_state,i,o)}function p(t,a,s,c,l){let u=h(s.snapshots,a.snapshots),d=g(s,a);if(m(s,a).forEach((e,t)=>{let r=n.get(t);if(r&&r.target){let t={primary:`#999`,auxiliary:`#FFF`};for(let n=0;n<e;n++)i.decreaseMessageCount(r.target,t)}}),d.size===0&&u.every(e=>e.tokens.size===0)){f(t,s,c,l+1);return}let p=0;d.forEach((r,a)=>{let o=n.get(a);if(!o)return;let u={element:o,colors:{primary:`#999`,auxiliary:`#FFF`}};for(let n=0;n<r;n++)p++,e.animate(o,u,()=>{p--,o.target&&i.increaseMessageCount(o.target,u.colors),p===0&&f(t,s,c,l+1)})}),u.forEach(i=>{i.tokens.forEach((a,u)=>{let d=n.get(u);if(!d)return;let m={element:d,colors:o.getColor(i.id)};for(let n=0;n<a;n++)p++,r.decreaseTokenCount(d.source,m.colors),e.animate(d,m,()=>{p--,r.increaseTokenCount(d.target,m.colors),p===0&&f(t,s,c,l+1)})})})}function m(e,t){let n=new Map;return t.messages.forEach((t,r)=>{let i=t-(e.messages.get(r)||0);i>0&&n.set(r,i)}),n}function h(e,t){let n=e.map(e=>({tokens:new Map(e.tokens),id:e.id}));return t.forEach(e=>{e.tokens.forEach((t,r)=>{let i=n.find(t=>t.id===e.id),a=i.tokens.get(r)-t;a>0?i.tokens.set(r,a):i.tokens.delete(r)})}),n}function g(e,t){let n=new Map(e.messages);return t.messages.forEach((e,t)=>{let r=n.get(t)-e;r>0?n.set(t,r):n.delete(t)}),n}}we.$inject=[`animation`,`eventBus`,`elementRegistry`,`tokenCount`,`messageCount`,`notifications`,`tokenColors`];var Te=getComputedStyle(document.documentElement),Ee=Te.getPropertyValue(`--token-simulation-green-base-44`),De=Te.getPropertyValue(`--token-simulation-white`);function Oe(){}function ke(e,t){return t.length===2?Ne:e===1?je:e===t.length-1?Me:Ae}var Ae=function(e){return e},je=function(e){return-Math.cos(e*Math.PI/2)+1},Me=function(e){return Math.sin(e*Math.PI/2)},Ne=function(e){return-Math.cos(e*Math.PI)/2+.5},I=20;function L(e,t){this._eventBus=t,this._canvas=e,this._randomize=!0,this._animations=new Set,this._speed=1,t.on(O,()=>{this.clearAnimations()}),t.on(T,()=>{this.pause()}),t.on(ue,()=>{this.play()}),t.on(w,e=>{e.active||this.clearAnimations()})}L.prototype.animate=function(e,t,n){this.createAnimation(e,t,n)},L.prototype.pause=function(){this.each(e=>e.pause())},L.prototype.play=function(){this.each(e=>e.play())},L.prototype.each=function(e){this._animations.forEach(e)},L.prototype.createAnimation=function(e,t,n=Oe){let r=this._getGroup(t);if(!r)return;let i=new R(this._createTokenGfx(r,t),e.waypoints,()=>{this._animations.delete(i),n()});return i.setSpeed(this.getAnimationSpeed()),i.scope=t,i.element=e,this._animations.add(i),this._eventBus.fire(de,{animation:i}),i.play(),i},L.prototype.setAnimationSpeed=function(e){this._speed=e,this.each(t=>t.setSpeed(e)),this._eventBus.fire(fe,{speed:e})},L.prototype.getAnimationSpeed=function(){return this._speed},L.prototype.clearAnimations=function(e){this.each(t=>{(!e||t.scope===e)&&t.remove()})},L.prototype._createTokenGfx=function(e,t){return l(p(this._getTokenSVG(t).trim()),e)},L.prototype._getTokenSVG=function(e){let t=e.colors||{primary:Ee,auxiliary:De};return`
    <g class="bts-token">
      <circle
        class="bts-circle"
        r="${I/2}"
  ...
  `},L.prototype._getGroup=function(e){let t=this._canvas,n=t.findRoot(e.element),r=t._findPlaneForRoot(n).layer,i=c(`.bts-animation-tokens`,r);return i||(i=p(`<g class="bts-animation-tokens" />`),l(i,r)),i},L.$inject=[`canvas`,`eventBus`];function R(e,t,n){this.gfx=e,this.waypoints=t,this.done=n,this._paused=!0,this._t=0,this._parts=[],this.create()}R.prototype.pause=function(){this._paused=!0},R.prototype.play=function(){this._paused&&(this._paused=!1,this.tick(0)),this.schedule()},R.prototype.schedule=function(){if(this._paused||this._scheduled)return;let e=Date.now();this._scheduled=!0,requestAnimationFrame(()=>{this._scheduled=!1,!this._paused&&(this.tick((Date.now()-e)*this._speed),this.schedule())})},R.prototype.tick=function(e){let t=this._t+=e,n=this._parts.find(e=>e.startTime<=t&&e.endTime>t);if(!n)return this.remove();let r=t-n.startTime,i=n.length*n.easing(r/n.duration),a=n.startLength+i,o=this._path.getPointAtLength(a);this.move(o.x,o.y)},R.prototype.move=function(e,t){o(this.gfx,`transform`,`translate(${e}, ${t})`)},R.prototype.create=function(){let e=this.waypoints,t=e.reduce((t,n,r)=>{let i=e[r-1];if(i){let a=t[t.length-1],o=a&&a.endLength||0,s=Ie(i,n);t.push({startLength:o,endLength:o+s,length:s,easing:ke(r,e)})}return t},[]),n=t.reduce(function(e,t){return e+t.length},0),r=e.reduce((e,t,n)=>{let r=t.x-I/2,i=t.y-I/2;return e.push([n>0?`L`:`M`,r,i]),e},[]).flat().join(` `),i=Pe(n,this._randomize);this._parts=t.reduce((e,t,r)=>{let a=i/n*t.length,o=r>0?e[r-1].endTime:0,s=o+a;return[...e,{...t,startTime:o,endTime:s,duration:a}]},[]),this._path=p(`<path d="${r}" />`),this._t=0},R.prototype.remove=function(){this.pause(),u(this.gfx),this.done()},R.prototype.setSpeed=function(e){this._speed=e};function Pe(e,t=!1){return Math.log(e)*(t?Fe(250,300):250)}function Fe(e,t){return e+Math.floor(Math.random()*(t-e))}function Ie(e,t){return Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2)}var Le={animation:[`type`,L]};function Re(e,n){return t(_(e).eventDefinitions,e=>g(e,n))}var ze=500,Be=10,Ve=-15,He=`--token-simulation-green-base-44`,Ue=`--token-simulation-white`,We=`token-count`;function z(e,t,n){this._overlays=t,this.overlayIdsAndCount={},e.on(O,()=>{this.clearTokenCounts()}),e.on(w,ze,e=>{e.active||this.clearTokenCounts()}),e.on(E,e=>{let t=e.element;h(t,[`bpmn:EndEvent`,`bpmn:EventBasedGateway`])&&this.decreaseTokenCount(t,n.getColorForElement(t)),g(t,`bpmn:ParallelGateway`)&&this.decreaseTokenCountBy(t,t.incoming.length-1,n.getColorForElement(t)),Re(_(t),`bpmn:TerminateEventDefinition`)&&t.parent.children.forEach(e=>this.removeAllTokens(e))})}z.prototype.addTokenCountOverlay=function(e,t,n){let r=a(`
    <div class="bts-token-count-parent">
      ${this._getTokenHTML(e,t,n)}
    </div>
  `),i={bottom:Be,left:Ve};return this._overlays.add(e,We,{position:i,html:r,show:{minZoom:.5}})},z.prototype.increaseTokenCount=function(e,t){let n=1,r=this.overlayIdsAndCount[e.id];r&&(this._overlays.remove(r.id),n=r.count+1);let i=this.addTokenCountOverlay(e,n,t);this.overlayIdsAndCount[e.id]={id:i,count:n}},z.prototype.clearTokenCounts=function(){this._overlays.remove({type:We}),this.overlayIdsAndCount={}},z.prototype.removeAllTokens=function(e){let t=this.overlayIdsAndCount[e.id];t&&(this._overlays.remove(t.id),delete this.overlayIdsAndCount[e.id])},z.prototype.decreaseTokenCountBy=function(e,t,n){let r=this.overlayIdsAndCount[e.id];if(r)if(this._overlays.remove(r.id),r.count>t){let i=r.count-t,a=this.addTokenCountOverlay(e,i,n);this.overlayIdsAndCount[e.id]={id:a,count:i}}else delete this.overlayIdsAndCount[e.id]},z.prototype.decreaseTokenCount=function(e,t){this.decreaseTokenCountBy(e,1,t)},z.prototype._getTokenHTML=function(e,t,n){return n||=this._getDefaultColors(),`
    <div class="bts-token-count waiting"
         style="color: ${n.auxiliary}; background: ${n.primary}">
      ${t}
    </div>
  `},z.prototype._getDefaultColors=function(){return{primary:He,auxiliary:Ue}},z.$inject=[`eventBus`,`overlays`,`tokenColors`];var Ge={__init__:[`tokenCount`],tokenCount:[`type`,z]},Ke=500,qe=-10,Je=-5,Ye=`message-count`,Xe=`<svg class="bts-count-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
  <path d="M1 4v9h14V4H1zm1.5 1h11L8 8.5 2.5 5zm-.5 7V5.5l6 4 6-4V12H2z"/>
</svg>`,Ze=`--token-simulation-grey-lighten-56`,Qe=`--token-simulation-white`;function B(e,t){this._overlays=t,this.overlayIdsAndCount={},e.on(O,()=>{this.clearMessageCounts()}),e.on(w,Ke,e=>{e.active||this.clearMessageCounts()})}B.prototype.addMessageCountOverlay=function(e,t,n){let r=a(`
    <div class="bts-message-count-parent">
      ${this._getMessageHTML(t,n)}
    </div>
  `),i={top:qe,right:Je};return this._overlays.add(e,Ye,{position:i,html:r,show:{minZoom:.5}})},B.prototype.increaseMessageCount=function(e,t){let n=1,r=this.overlayIdsAndCount[e.id];r&&(this._overlays.remove(r.id),n=r.count+1);let i=this.addMessageCountOverlay(e,n,t);this.overlayIdsAndCount[e.id]={id:i,count:n}},B.prototype.clearMessageCounts=function(){this._overlays.remove({type:Ye}),this.overlayIdsAndCount={}},B.prototype.decreaseMessageCountBy=function(e,t,n){let r=this.overlayIdsAndCount[e.id];if(r)if(this._overlays.remove(r.id),r.count>t){let i=r.count-t,a=this.addMessageCountOverlay(e,i,n);this.overlayIdsAndCount[e.id]={id:a,count:i}}else delete this.overlayIdsAndCount[e.id]},B.prototype.decreaseMessageCount=function(e,t){this.decreaseMessageCountBy(e,1,t)},B.prototype._getMessageHTML=function(e,t){return t||=this._getDefaultColors(),`
    <div class="bts-message-count waiting"
         style="color: ${t.auxiliary}; background: ${t.primary}">
      ${e}
      ${Xe}
    </div>
  `},B.prototype._getDefaultColors=function(){return{primary:`var(${Ze})`,auxiliary:`var(${Qe})`}},B.$inject=[`eventBus`,`overlays`];var $e={__init__:[`messageCount`],messageCount:[`type`,B]},et=(0,e(ne(),1).default)({count:60}).filter(e=>rt(e)<200),tt=0,nt=new Map;function rt(e){let t=parseInt(e.substring(1,3),16),n=parseInt(e.substring(3,5),16),r=parseInt(e.substring(5,7),16);return(t*299+n*587+r*114)/1e3}function V(e){e.on(D,()=>{tt=0,nt.clear()})}V.$inject=[`eventBus`],V.prototype.getColor=function(e){let t=nt.get(e);if(t)return t;let n=et[tt++%et.length];return t={primary:n,auxiliary:rt(n)>=128?`#111`:`#fff`},nt.set(e,t),t},V.prototype.getColorForElement=function(e){return e.parent.businessObject.processRef?this.getColor(e.parent.businessObject.processRef.id):this.getColor(e.parent.id)};var it={__init__:[`tokenColors`],tokenColors:[`type`,V]},at=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M12.83 352h262.34A12.82 12.82 0 0 0 288 339.17v-38.34A12.82 12.82 0 0 0 275.17 288H12.83A12.82 12.82 0 0 0 0 300.83v38.34A12.82 12.82 0 0 0 12.83 352zm0-256h262.34A12.82 12.82 0 0 0 288 83.17V44.83A12.82 12.82 0 0 0 275.17 32H12.83A12.82 12.82 0 0 0 0 44.83v38.34A12.82 12.82 0 0 0 12.83 96zM432 160H16a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16v-32a16 16 0 0 0-16-16zm0 256H16a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16v-32a16 16 0 0 0-16-16z"/></svg>`,ot=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M20 424.229h20V279.771H20c-11.046 0-20-8.954-20-20V212c0-11.046 8.954-20 20-20h112c11.046 0 20 8.954 20 20v212.229h20c11.046 0 20 8.954 20 20V492c0 11.046-8.954 20-20 20H20c-11.046 0-20-8.954-20-20v-47.771c0-11.046 8.954-20 20-20zM96 0C56.235 0 24 32.235 24 72s32.235 72 72 72 72-32.235 72-72S135.764 0 96 0z"/></svg>`,st=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z"/></svg>`,ct=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M440.65 12.57l4 82.77A247.16 247.16 0 0 0 255.83 8C134.73 8 33.91 94.92 12.29 209.82A12 12 0 0 0 24.09 224h49.05a12 12 0 0 0 11.67-9.26 175.91 175.91 0 0 1 317-56.94l-101.46-4.86a12 12 0 0 0-12.57 12v47.41a12 12 0 0 0 12 12H500a12 12 0 0 0 12-12V12a12 12 0 0 0-12-12h-47.37a12 12 0 0 0-11.98 12.57zM255.83 432a175.61 175.61 0 0 1-146-77.8l101.8 4.87a12 12 0 0 0 12.57-12v-47.4a12 12 0 0 0-12-12H12a12 12 0 0 0-12 12V500a12 12 0 0 0 12 12h47.35a12 12 0 0 0 12-12.6l-4.15-82.57A247.17 247.17 0 0 0 255.83 504c121.11 0 221.93-86.92 243.55-201.82a12 12 0 0 0-11.8-14.18h-49.05a12 12 0 0 0-11.67 9.26A175.86 175.86 0 0 1 255.83 432z"/></svg>`,lt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M144 479H48c-26.5 0-48-21.5-48-48V79c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v352c0 26.5-21.5 48-48 48zm304-48V79c0-26.5-21.5-48-48-48h-96c-26.5 0-48 21.5-48 48v352c0 26.5 21.5 48 48 48h96c26.5 0 48-21.5 48-48z"/></svg>`,ut=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Adapted from Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"/></svg>`,dt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"/></svg>`,ft=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M288 32C128.94 32 0 160.94 0 320c0 52.8 14.25 102.26 39.06 144.8 5.61 9.62 16.3 15.2 27.44 15.2h443c11.14 0 21.83-5.58 27.44-15.2C561.75 422.26 576 372.8 576 320c0-159.06-128.94-288-288-288zm0 64c14.71 0 26.58 10.13 30.32 23.65-1.11 2.26-2.64 4.23-3.45 6.67l-9.22 27.67c-5.13 3.49-10.97 6.01-17.64 6.01-17.67 0-32-14.33-32-32S270.33 96 288 96zM96 384c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm48-160c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm246.77-72.41l-61.33 184C343.13 347.33 352 364.54 352 384c0 11.72-3.38 22.55-8.88 32H232.88c-5.5-9.45-8.88-20.28-8.88-32 0-33.94 26.5-61.43 59.9-63.59l61.34-184.01c4.17-12.56 17.73-19.45 30.36-15.17 12.57 4.19 19.35 17.79 15.17 30.36zm14.66 57.2l15.52-46.55c3.47-1.29 7.13-2.23 11.05-2.23 17.67 0 32 14.33 32 32s-14.33 32-32 32c-11.38-.01-20.89-6.28-26.57-15.22zM480 384c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32z"/></svg>`,pt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><!-- Font Awesome Free 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"/></svg>`;function H(e){return function(t=``){return`<span class="bts-icon ${t}">${e}</span>`}}var mt=H(at),ht=H(ot),gt=H(st),_t=H(ct),vt=H(lt),yt=H(ut),bt=H(ft),xt=H(pt),St=H(dt),Ct=2e3,wt=ht();function U(e,t){this._eventBus=e,this._canvas=t,this._init(),e.on([w,O],()=>{this.clear()})}U.prototype._init=function(){this.container=a(`<div class="bts-notifications"></div>`),this._canvas.getContainer().appendChild(this.container)},U.prototype.showNotification=function(e){let{text:t,type:n=`info`,icon:r=wt,scope:i,ttl:o=Ct}=e,s=r.startsWith(`<`)?r:`<i class="${r}"></i>`,c=i&&i.colors,l=c?`style="color: ${c.auxiliary}; background: ${c.primary}"`:``,u=a(`
  ...
  `),d.bind(this.paletteEntry,`click`,()=>{this.toggle()}),this._tokenSimulationPalette.addEntry(this.paletteEntry,3)},W.prototype.isShown=function(){let e=this._container;return!s(e).has(`hidden`)},W.prototype.toggle=function(e=!this.isShown()){let t=this._container;e?s(t).remove(`hidden`):s(t).add(`hidden`)},W.prototype.log=function(e){let{text:t,type:n=`info`,icon:r=Et,scope:i}=e,o=this._content;s(this._placeholder).add(`hidden`),this.isShown()||this._notifications.showNotification(e);let c=r.startsWith(`<`)?r:`<i class="${r}"></i>`,l=i&&i.colors,u=l?`style="background: ${l.primary}; color: ${l.auxiliary}"`:``,d=a(`
    <p class="bts-entry ${n}" ${i?`data-scope-id="${i.id}"`:``}>
      <span class="bts-icon">${c}</span>
      <span class="bts-text" title="${t}">${t}</span>
      ${i?`<span class="bts-scope" data-scope-id="${i.id}" ${u}>${i.id}</span>`:``}
    </p>
  `),f=Math.abs(o.clientHeight+o.scrollTop-o.scrollHeight)<2;o.appendChild(d),f&&(o.scrollTop=o.scrollHeight)},W.prototype.clear=function(){for(;this._content.firstChild;)this._content.removeChild(this._content.firstChild);this._placeholder=a(`<p class="bts-entry placeholder">No Entries</p>`),this._content.appendChild(this._placeholder)},W.$inject=[`eventBus`,`notifications`,`canvas`,`tokenSimulationPalette`,`tokenColors`];var jt={__depends__:[Tt],__init__:[`log`],log:[`type`,W]},Mt=10001;function Nt(e,t,n,r,i,a,o){let s=!1;e.on(w,Mt,e=>{s=e.active,s&&(r.cancel(),t.close(),n.cancel()),o._update()});function c(e,t,n){let r=e[t];e[t]=function(){return n.call(this,r,arguments)}}function l(e,t){c(e,t,function(e,t){if(!s)return e.apply(this,t)})}function u(e,t){c(e,t,function(e,t){if(s)throw Error(`model is read-only`);return e.apply(this,t)})}l(t,`open`),l(n,`init`),l(r,`activate`),l(n,`init`),l(r,`activate`),u(a,`moveShape`),u(a,`updateAttachment`),u(a,`moveElements`),u(a,`moveConnection`),u(a,`layoutConnection`),u(a,`createConnection`),u(a,`createShape`),u(a,`createLabel`),u(a,`appendShape`),u(a,`removeElements`),u(a,`distributeElements`),u(a,`removeShape`),u(a,`removeConnection`),u(a,`replaceShape`),u(a,`pasteElements`),u(a,`alignElements`),u(a,`resizeShape`),u(a,`createSpace`),u(a,`updateWaypoints`),u(a,`reconnectStart`),u(a,`reconnectEnd`),c(i,`trigger`,function(e,t){let n=t[0];if(!(s&&Pt([`undo`,`redo`,`copy`,`paste`,`removeSelection`,`spaceTool`,`lassoTool`,`globalConnectTool`,`distributeElements`,`alignElements`,`directEditing`],n)))return e.apply(this,t)})}Nt.$inject=[`eventBus`,`contextPad`,`dragging`,`directEditing`,`editorActions`,`modeling`,`palette`];function Pt(e,t){return e.indexOf(t)>-1}var Ft={__init__:[`disableModeling`],disableModeling:[`type`,Nt]};function G(e,t){let n=this;this._canvas=t,this.entries=[],this._init(),e.on(`diagram.init`,()=>{this._canvasParent=this._canvas.getContainer().parentNode,this._palette=c(`.djs-palette`,this._canvas.getContainer())}),e.on(w,function(e){e.active?(s(n.container).remove(`hidden`),s(n._canvasParent).add(`simulation`),s(n._palette).add(`hidden`)):(s(n.container).add(`hidden`),s(n._canvasParent).remove(`simulation`),s(n._palette).remove(`hidden`))})}G.prototype._init=function(){this.container=a(`<div class="bts-palette hidden"></div>`),this._canvas.getContainer().appendChild(this.container)},G.prototype.addEntry=function(e,t){let n=0;this.entries.forEach(function(e){t>=e.index&&n++}),this.container.insertBefore(e,this.container.childNodes[n]),this.entries.push({entry:e,index:t})},G.$inject=[`eventBus`,`canvas`];var It={__init__:[`tokenSimulationPalette`],tokenSimulationPalette:[`type`,G]};function K(e,t){this._eventBus=e,this._tokenSimulationPalette=t,this._init()}K.prototype._init=function(){this._paletteEntry=a(`
    <div class="bts-entry" title="Restart execution example">
      ${_t()}
    </div>
  `),d.bind(this._paletteEntry,`click`,()=>{this.restartCounterExample()}),this._tokenSimulationPalette.addEntry(this._paletteEntry,2)},K.prototype.restartCounterExample=function(){this._eventBus.fire(O)},K.$inject=[`eventBus`,`tokenSimulationPalette`];var Lt={__init__:[`restartCounterExample`],restartCounterExample:[`type`,K]},Rt=yt(),zt=vt();function q(e,t,n,r){this._eventBus=e,this._tokenSimulationPalette=t,this._notifications=n,this.canvasParent=r.getContainer().parentNode,this.isPaused=!1,this._init()}q.prototype._init=function(){this.paletteEntry=a(`
    <div class="bts-entry" title="Play/Pause Execution">
      ${zt}
    </div>
  `),d.bind(this.paletteEntry,`click`,this.toggle.bind(this)),this._tokenSimulationPalette.addEntry(this.paletteEntry,1),this._eventBus.on(O,()=>{s(this.paletteEntry).remove(`active`),s(this.canvasParent).remove(`paused`),this.paletteEntry.innerHTML=zt,this.isPaused=!1})},q.prototype.toggle=function(){this.isPaused?this.unpause():this.pause()},q.prototype.pause=function(){s(this.paletteEntry).add(`active`),s(this.canvasParent).add(`paused`),this.paletteEntry.innerHTML=Rt,this._eventBus.fire(T),this._notifications.showNotification({text:`Pause Execution`}),this.isPaused=!0},q.prototype.unpause=function(){this.isPaused&&=(s(this.paletteEntry).remove(`active`),s(this.canvasParent).remove(`paused`),this.paletteEntry.innerHTML=zt,this._eventBus.fire(ue),this._notifications.showNotification({text:`Play Execution`}),!1)},q.$inject=[`eventBus`,`tokenSimulationPalette`,`notifications`,`canvas`];var Bt={__depends__:[Tt],__init__:[`pauseExecution`],pauseExecution:[`type`,q]},Vt=St();function J(e,t,n){this._eventBus=e,this._tokenSimulationPalette=t,this.canvasParent=n.getContainer().parentNode,this.isPaused=!1,this._init()}J.prototype._init=function(){this.paletteEntry=a(`
    <div class="bts-entry" title="Back to modeling">
      ${Vt}
    </div>
  `),d.bind(this.paletteEntry,`click`,this.toggle.bind(this)),this._tokenSimulationPalette.addEntry(this.paletteEntry,0)},J.prototype.toggle=function(){this._eventBus.fire(w,{active:!1})},J.$inject=[`eventBus`,`tokenSimulationPalette`,`canvas`];var Ht={__init__:[`toggleModeling`],toggleModeling:[`type`,J]},Ut=[[`Slow`,.5],[`Normal`,1],[`Fast`,2]];function Y(e,t,n){this._canvas=e,this._animation=t,this._eventBus=n,this._init(t.getAnimationSpeed()),n.on(w,e=>{e.active?s(this._container).remove(`hidden`):s(this._container).add(`hidden`)}),n.on(fe,e=>{this.setActive(e.speed)})}Y.prototype.getToggleSpeed=function(e){return parseFloat(e.dataset.speed)},Y.prototype._init=function(e){this._container=a(`
      ...
      <div class="bts-animation-speed-buttons">
        ${Ut.map(([t,n],r)=>`
            <button title="Set animation speed = ${t}" data-speed="${n}" class="bts-animation-speed-button ${n===e?`active`:``}">
              ${Array.from({length:r+1}).map(()=>xt()).join(``)}
            </button>
          `).join(``)}
      </div>
    </div>
  `),f.bind(this._container,`[data-speed]`,`click`,e=>{let t=e.delegateTarget,n=this.getToggleSpeed(t);this._animation.setAnimationSpeed(n)}),this._canvas.getContainer().appendChild(this._container)},Y.prototype.setActive=function(e){m(`[data-speed]`,this._container).forEach(t=>{let n=this.getToggleSpeed(t)===e;s(t)[n?`add`:`remove`](`active`)})},Y.$inject=[`canvas`,`animation`,`eventBus`];var Wt={__depends__:[Le,Ge,$e,it,Tt,jt,Ft,It,Lt,Bt,Ht,{__init__:[`setAnimationSpeed`],setAnimationSpeed:[`type`,Y]}],__init__:[`counterExampleVisualizer`],counterExampleVisualizer:[`type`,we]},Gt=``;function Kt(e,t,n,r){e.on(`analysis.done`,i),this._canvas=n,this._init();function i(e){if(e.unsupported_elements&&e.unsupported_elements.length>0){a(e);return}e.property_results.length!==S.length&&o();for(let t of e.property_results)s(t)}function a(e){for(let n of e.unsupported_elements){let e=r.get(n);t.add(n,k,{position:{top:-45,left:e.width/2-17},html:`<div class="small-note tooltip warning-note">
                 <img alt="quick-fix" src="data:image/svg+xml;base64,${Gt}"/>
                 <span class="tooltipText">This element is currently unsupported by the analyzer.</span>
               </div>`})}o()}function o(){for(let e of S){let t=document.getElementById(e);if(!t)continue;t.classList.remove(`violated`,`fulfilled`);let n=document.getElementById(`${e}-icon`);n&&(n.classList.add(`icon-question`),n.classList.remove(`icon-check`,`icon-xmark`,`fulfilled`,`violated`))}}function s(e){let t=document.getElementById(`${e.property}`),n=document.getElementById(`${e.property}-icon`);!t||!n||(e.fulfilled?(t.classList.remove(`violated`),t.classList.add(`fulfilled`),n.classList.remove(`icon-question`,`icon-xmark`,`violated`),n.classList.add(`icon-check`,`fulfilled`)):(t.classList.remove(`fulfilled`),t.classList.add(`violated`),n.classList.remove(`icon-question`,`icon-check`,`fulfilled`),n.classList.add(`icon-xmark`,`violated`)))}}Kt.prototype._init=function(){let e=a(`
  ...
  `);this._canvas.getContainer().appendChild(e)},Kt.$inject=[`eventBus`,`overlays`,`canvas`,`elementRegistry`];var qt={__depends__:[le,A,{__init__:[`propertiesSummary`],propertiesSummary:[`type`,Kt]},Ce,Wt]},X={taskSplit:`<?xml version="1.0" encoding="UTF-8"?>
...
`};function Jt(e,t){this._canvas=t,this._eventBus=e,this._init()}Jt.prototype._init=function(){let e=a(`
  ...
  `),n=document.getElementById(`io-editing-tools-buttons`);n.prepend(t),n.prepend(e),document.getElementById(`example-select`).addEventListener(`change`,e=>{let t=X[e.currentTarget.value];this._eventBus.fire(`example.import`,{xml:t})});let r=new URLSearchParams(window.location.search).get(`model`);r&&X[r]?this._eventBus.on(`example.init`,()=>{let e=X[r];this._eventBus.fire(`example.import`,{xml:e}),document.getElementById(`example-select`).value=r}):this._eventBus.on(`example.init`,()=>{let e=X.unsafeGateways;this._eventBus.fire(`example.import`,{xml:e})})},Jt.$inject=[`eventBus`,`canvas`];var Z=new te({container:`#canvas`,additionalModules:[qt,{__init__:[`analysisExamples`],analysisExamples:[`type`,Jt]}]});function Yt(e){e.requestFullscreen()}function Xt(){document.exitFullscreen()}var Q={fullScreen:!1,keyboardHelp:!1};document.getElementById(`js-toggle-fullscreen`).addEventListener(`click`,function(){Q.fullScreen=!Q.fullScreen,Q.fullScreen?Yt(document.documentElement):Xt()}),document.getElementById(`js-toggle-keyboard-help`).addEventListener(`click`,function(){Q.keyboardHelp=!Q.keyboardHelp;let e=`none`;Q.keyboardHelp&&(e=`block`),document.getElementById(`io-dialog-main`).style.display=e}),document.getElementById(`io-dialog-main`).addEventListener(`click`,function(){Q.keyboardHelp=!Q.keyboardHelp,Q.keyboardHelp||(document.getElementById(`io-dialog-main`).style.display=`none`)});function Zt(e,t){if(!e)return;let n=new FileReader;n.onload=function(e){let n=e.target.result;t(n)},n.readAsText(e)}var $=document.createElement(`input`);$.setAttribute(`type`,`file`),$.style.display=`none`,document.body.appendChild($),$.addEventListener(`change`,function(e){Zt(e.target.files[0],Qt)});function Qt(e){Z.importXML(e).catch(function(e){if(e)return console.error(`could not import xml`,e)})}function $t(){return Z.saveSVG()}function en(){return Z.saveXML({format:!0})}var tn=document.getElementById(`js-download-board`),nn=document.getElementById(`js-download-svg`),rn=document.getElementById(`js-open-new`),an=document.getElementById(`js-open-board`);function on(e,t,n){let r=encodeURIComponent(n);n?(e.classList.add(`active`),e.setAttribute(`href`,`data:application/xml;charset=UTF-8,`+r),e.setAttribute(`download`,t)):e.classList.remove(`active`)}var sn=cn(function(){$t().then(function(e){on(nn,`bpmn.svg`,e.svg)}),en().then(function(e){on(tn,`bpmn.bpmn`,e.xml),Z.get(`eventBus`).fire(`analysis.start`,e)})},500);Z.on(`commandStack.changed`,sn),Z.on(`import.done`,sn),Z.on(`example.import`,e=>Qt(e.xml)),rn.addEventListener(`click`,function(){Qt(re)}),an.addEventListener(`click`,function(){$.value=``,$.click()}),Z.get(`eventBus`).fire(`example.init`,{});function cn(e,t){let n;return function(){n&&clearTimeout(n),n=setTimeout(e,t)}}